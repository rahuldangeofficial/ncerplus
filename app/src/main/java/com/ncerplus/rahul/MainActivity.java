...
public class MainActivity extends AppCompatActivity
    ...
    final String url="https://ncerplus.blogspot.com/p/main.html";
   ...
   final void requestNewInterstitial() {
     ...
     void webSettings(){
        ...
        mWebView.setWebViewClient(new WebViewClient()
        {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if(url.contains("youtube.com") || url.contains("drive.google.com")||url.contains("escapelink")||url.contains("cutt.ly")||url.contains("linkedin.com")||url.contains("spreadsheets.google.com")|| url.contains("dbatuapps.in")|| url.contains("dbatu.ac.in")  || url.contains("play.google.com") ||url.contains("docs.google.com") ||url.contains("forms.gle") || url.contains("google.com/maps") || url.contains("facebook.com") || url.contains("twitter.com") || url.contains("instagram.com")){
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.item2) {
            ...
            mWebView.setVisibility(View.VISIBLE);
            frameLayout.setVisibility(View.GONE);
            mWebView.loadUrl("https://www.linkedin.com/in/roman-thapa-120223191");
            ...
            mWebView.setVisibility(View.VISIBLE);
            frameLayout.setVisibility(View.GONE);
            mWebView.loadUrl("https://docs.google.com/forms/d/e/1FAIpQLScpztEBn_i0RpltLM-jJTFw36royrJXIsjHLLDYMI2AIJ8FjA/viewform?usp=sf_link");
            ...
            mWebView.setVisibility(View.VISIBLE);
            frameLayout.setVisibility(View.GONE);
            mWebView.loadUrl("https://ncerplus.blogspot.com/p/help-us-to-improve-content.html");
            ...
            mWebView.setVisibility(View.VISIBLE);
            frameLayout.setVisibility(View.GONE);
            mWebView.loadUrl("https://www.linkedin.com/in/rahuldangeofficial");
